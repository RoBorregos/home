...
class TaskManagerServer:
    ...
    def __init__(self) -> None:
        ...
        self.subtask_manager["nav"].go_place("kitchen table_pick")
        self.subtask_manager["manipulation"].go_to_joint_position("PICK_JOINT_POSITION")
        object_name = self.subtask_manager["vision"].get_object()
        category = self.subtask_manager["hri"].get_objects_category({object_name})
        self.subtask_manager["hri"].speak(f"I found a {object_name} which fits the {category} category")
        self.subtask_manager["manipulation"].execute_pick(object_name)
        self.subtask_manager["nav"].go_place("shelves")
